...
public class genericCard {
    ...
    public genericCard(int mana, int health, int attackDamage,
                       String name, String description, ArrayList<String> colors) {
        this.mana = mana;
        this.health = health;
     ...
     */
    public genericCard(CardInput input) {
     ...
     */
    public int attack(genericCard enemy) {
     ...
     */
    public void freeze(genericCard enemy) {
        enemy.isFrozen = true;
    }
    ...
    public ObjectNode printCard() {
        ...
        for (String color : colors) colorsArray.add(color);
